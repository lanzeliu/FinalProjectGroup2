...
public class YearSetItems {
	...
	public ArrayList<String> getYearItems(ArrayList<Vehicle> vehiclesCollection, String Make, String Model) {
		...
		for (int year=this.minYear; year<=this.maxYear; year++) {
			yearItemsList.add(String.valueOf(year));
		}
	...
	public static void main(String[] args) {
		...
		for (String i : ysiTest.getYearItems(vehiclesCollectionTest, "", "")) {
